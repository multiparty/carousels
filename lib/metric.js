        ...
        CallExpression: {
          "exit": function (p) {
            ...
            if(op_name == "map" || op_name == "reduce"){
              ...
              var keyword = "answers";  // Dynamic array variable name
              var length_poly = ((p.node.arguments[0].type == "Identifier") && p.node.arguments[0].name == keyword)
                                : polynomium.v('n').toObject()
                                ;
