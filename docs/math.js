...
=======
  console.log('before', n, parser.scope.n);
  parser.set('n', n);
  console.log('after', n, parser.scope.n);
  return above_base_case ? parser.evaluate(thunk_f) : base_val;
});
...
// const fib = parser.evaluate(get_rec_def('f(n) = f(n-1) + f(n-2)', 'f(1) = 1'))
...
//     context.map(def => parser.evaluate(def));
//   } else {
